...
while(yourPick.health >= 0 and opponentPick.health >= 0):
    ...
    yourMove = int(input("Type the number of the move you would like to use corresponding to the name as it appeared above. Pick '5' to regen 20% of your remaining health.\n"))
